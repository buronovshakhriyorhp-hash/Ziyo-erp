...
export const StudentDashboardLayout: React.FC = () => {
  ...
  const getHeaderInfo = () => {
    switch (location.pathname) {
      case '/student-portal':
        return 'Bosh sahifa';
      case '/student-portal/payments':
        return "To'lovlarim";
      case '/student-portal/groups':
        return 'Guruhlarim';
      case '/student-portal/analytics':
        return "Ko'rsatkichlarim";
      case '/student-portal/rating':
        return 'Reyting';
      case '/student-portal/extra-lessons':
        return "Qo'shimcha darslar";
      case '/student-portal/shop':
        return "Do'kon";
      case '/student-portal/settings':
        return 'Sozlamalar';
      case '/student-portal/notifications':
        return 'Xabarnomalar';
      default:
  ...
  return (
    <div className="flex bg-[#0f172a] min-h-screen font-sans text-slate-300 overflow-hidden font-inter selection:bg-emerald-500/30">
      ...
      <StudentDashboardSidebar isMobileOpen={isMobileMenuOpen} onMobileClose={() => setIsMobileMenuOpen(false)} />
        ...
        <header className="h-16 md:h-20 bg-[#0f172a]/80 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-4 md:px-8 transition-all duration-300 z-30 sticky top-0">
          ...
          <div className="flex items-center gap-2 md:gap-5">
            <div className="hidden lg:flex items-center bg-black/20 border border-white/5 rounded-full px-4 py-2 drop-shadow-sm group hover:border-white/10 transition-colors w-64 focus-within:w-80 focus-within:border-emerald-500/50">
              ...
              <input
                type="text"
                placeholder="Guruh yoki vazifa qidirish..."
            ...
            <div className="relative">
              ...
              >
                <div className="text-right hidden sm:block">
                  ...
                  <p className="text-[10px] font-medium text-emerald-400 uppercase tracking-widest mt-1">O'quvchi</p>
                </div>
                    ...
                    <div className="p-2">
                      <button
                        onClick={() => {
                          ...
                          navigate('/student-portal/settings');
                        }}
