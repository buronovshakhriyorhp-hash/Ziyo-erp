...
import { Bell, Menu, Search, UserCircle, LogOut, Settings, GraduationCap } from 'lucide-react';
...
export const AdminDashboardLayout: React.FC = () => {
    ...
    const getPageTitle = () => {
        switch (true) {
            case location.pathname === '/dashboard':
                return 'Boshqaruv Markazi';
            case location.pathname.startsWith('/academic/groups'):
                return 'Guruhlar Boshqaruvi';
            case location.pathname.startsWith('/students'):
                return 'Talabalar Bazasi';
            case location.pathname.startsWith('/finance/salaries'):
                return "O'qituvchilar";
            case location.pathname.startsWith('/admin/shop'):
                return "Do'kon Boshqaruvi";
            case location.pathname.startsWith('/analytics'):
                return 'Moliyaviy Hisobotlar';
            case location.pathname.startsWith('/audit'):
                return 'Harakatlar Jurnali';
            case location.pathname.startsWith('/users'):
                return 'Tizim Foydalanuvchilari';
    ...
    return (
        <div className="flex bg-[#0f172a] min-h-screen font-sans text-slate-300 overflow-hidden font-inter selection:bg-emerald-500/30">
            ...
            <AdminDashboardSidebar isMobileOpen={isMobileMenuOpen} onMobileClose={() => setIsMobileMenuOpen(false)} />
                        ...
                        <div className="relative">
                            ...
                            >
                                <div className="text-right hidden sm:block">
                                    ...
                                    <p className="text-[10px] font-medium text-emerald-400 uppercase tracking-widest mt-1">Admin</p>
                                </div>
                                ...
                                <>
                                    ...
                                    <div className="absolute right-0 mt-2 w-48 bg-[#1e293b] rounded-2xl shadow-2xl border border-white/10 overflow-hidden z-50 animate-in fade-in slide-in-from-top-2">
                                        ...
                                        <div className="p-2">
                                            ...
                                            >
                                                <GraduationCap className="w-4 h-4" /> O'qituvchi Portali
                                            </button>
                                            <button
                                                onClick={() => {
                                                    setIsProfileDropdownOpen(false);
